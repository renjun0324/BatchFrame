...
assert(wxss.includes('.frame-style-card { display: inline-flex; width: 112px'), 'inner-frame cards should use the product preview size');
assert(wxss.includes('.frame-card-sample { position: relative; height: 70px'), 'all frame samples should use the product preview height');
