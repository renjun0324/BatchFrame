...
assert(wxss.includes('.frame-style-card, .basic-frame-card { display: inline-flex; width: 88px'), 'film rebate cards should also match template card width');
assert(wxss.includes('.frame-card-sample, .basic-frame-card .frame-card-sample { position: relative; height: 48px'), 'all frame samples should use the compact card height');
