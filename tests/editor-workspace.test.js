...
assert(wxss.includes('.frame-style-card, .basic-frame-card { display: inline-flex; width: 112px'), 'film rebate cards should use the larger product preview size');
assert(wxss.includes('.frame-card-sample, .basic-frame-card .frame-card-sample { position: relative; height: 70px'), 'all frame samples should use the larger product preview height');
